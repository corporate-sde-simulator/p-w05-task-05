...
> **Welcome to Product-Track Week 5, Task 5!**
...
| `src/SpanContext.java` | Main source code - **has bugs to fix** |
| `src/TracePropagator.java` | Supporting code - **may also have bugs** |
| `tests/TracePropagatorTest.java` | Test file - **add your tests here** |
